...
DEFAULT_AML_PROMPT = (
    ...
    "Retrieval evidence (quality_hint, good/bad similarity) is a navigation signal — it identifies where to look, not what to conclude. "
    "If morphology and retrieval disagree, morphology determines the final class.\n"
