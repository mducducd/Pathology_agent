...
WSITileSelectorAgent = Agent(
    ...
    instructions=(
        ...
        "- Prefer dark-ish or basophilic cellular regions only when they show preserved nuclear detail; avoid pale/empty background and artifact-dark fields.\n"
...
WSIAmlDetectorAgent = Agent(
    ...
    instructions=(
        ...
        "\n"
        "NAVIGATION:\n"
        "- Start with wsi_get_overview_view, then zoom into the most cellular, basophilic regions with preserved nuclear detail.\n"
        "- Darkness is only a rough cue. A region is potentially blast-rich only if it shows packed viable cells with visible nuclei/nucleoli, good focus, and low artifact.\n"
        "- Do not treat stain precipitate, tissue folds, hemorrhagic/clotted material, necrotic debris, out-of-focus dense regions, or smudged/crushed cells as blast-rich.\n"
